...
`runtime/status.json`, `runtime/DASHBOARD.md`, `runtime/CYCLE-BRIEF.md`, `runtime/OPERATING-REVIEW.md`, `runtime/CEO-SESSION-REVIEW.md`, `runtime/agent-logs/`, `runtime/work-products/`는 최신 실행을 가리키는 latest 출력입니다.
